...
const Footer = () => {
  return (
    <div className="foot bg-gradient-to-r from-gray-800 to-[#ccfe01]  text-white">
      <div className="flex flex-wrap">
        <div className="p-5 lg:p-10 w-full md:w-1/3">
          ...
          <ul className="flex mt-5">
            <li className=" shadow rounded mx-1">
              <a href="" className="">
                <svg
                  fill="currentColor"
      ...
      <div className="flex py-[1rem]">
        <p className="mx-auto">@2023 Hathor union inc. All rights reserved</p>
      </div>
    </div>
  );
};
